    ...
    return (
        <section className="w-full bg-[#000000] bg-[linear-gradient(to_top,_rgba(144,234,242,.3)_0%,_rgba(0,0,0,0)_9%)] text-white leading-none">
            <div className="w-full py-16 px-[5.9701%] md:px-[7.4074%] flex flex-col items-center gap-y-8">
                ...
                <img src={bannerImg} alt="2024 API Conference Recap" className="w-full h-full object-cover bg-[radial-gradient(circle,_transparent_0%,_#90EAF2_100%)]" />
                <a 
                    ...
                    href="#" aria-label="Watch 2024 recap video" role="button"
                >
                    Watch
                </a>
                </div>
            ...
            <div className="w-full py-16 flex flex-col gap-y-8">
                ...
                <h3 className="w-[93px] h-[28px] bg-[#FFF] border border-solid border-[#ECC89D] shadow-[inset_0_0_12px_0_#E1EF9A] rounded-2xl flex justify-center items-center text-lg text-[#000000] font-bold">THEMES</h3>
