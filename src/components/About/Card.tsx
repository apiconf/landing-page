        ...
        <h1 className=" text-[color:#4334D3] text-2xl lg:text-3xl font-bold">
            ...
            <div className=" flex items-start max-[450px]:flex-col gap-6 self-stretch">
                ...
                <div className="flex p-6 rounded-2xl shadow-lg self-stretch gap-4 flex-1 flex-col">
                    ...
                    <h1 className="absolute text-[color:white] md:text-[23px] xl:text-[28px] font-extrabold px-4 max-[480px]:text-[27px] py-[14px] right-0 bottom-0 left-0 top-0">Experienced</h1>
                ...
                <div className="relative pt-4">
                    <h1 className="absolute text-[color:white] max-[480px]:text-[26px]  xl:text-[28px] md:text-[23px] font-extrabold px-4 md:px-3 py-[14px] right-0 bottom-0 left-0 top-0">Foundational</h1>
                    <img src={rectangle} className="shrink-0" />
                    </div>
                ...
                <img className="shrink-0 gap-4 pt-6 max-[480px]:items-start flex max-[480px]:px-10" src={imageAbstract} alt="Trademarks" />
        </div>
        </div>
        </div>
    </body>
