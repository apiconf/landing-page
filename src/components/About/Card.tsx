    ...
    <>
      <body className="bg-custom-blue">
        <div className="relative">
          <p className="absolute bottom-0 top-0 text-4xl text-[color:#E2EF9C] px-28 pt-24">
...
const Card = () => {
  return (
    <body className="bg-custom-blue">
        ...
        <div className="bg-[color:white] rounded-2xl flex flex-col justify-end items-start self-stretch gap-4 p-4">
            <h1 className="self-stretch text-[color:#4334D3] text-3xl font-sans font-bold">
            ...
            <div className=" flex items-start gap-6 self-stretch">
                <div className="flex p-6 rounded-2xl shadow-lg self-stretch gap-4 flex-1 flex-col">
                    ...
                    <h1 className="absolute text-[color:white] text-2xl font-mono font-extrabold px-4 py-5 right-0 bottom-0 left-0 top-0">Experienced</h1>
                ...
                <div className="relative pt-4">
                    <h1 className="absolute text-[color:white] text-2xl font-mono font-extrabold pl-2 py-5 right-0 bottom-0 left-0 top-0">Foundational</h1>
                    <img src={rectangle} className="shrink-0" />
                    </div>
