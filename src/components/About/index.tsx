      ...
      >
        ...
        >
          <div className={aboutStyles.buttons}>
            <div
              className={`group ${aboutStyles.button} ${aboutStyles.custom_transition} hover:bg-white focus:bg-white ${endpointIndex === 1 ? 'bg-white' : ''}`}
              onClick={() => setEndpointIndex(1)}
            >
              <div
                className={`${aboutStyles.buttonIcons} ${aboutStyles.custom_transition} group-hover:bg-[#E1EF9A] group-hover:p-1 group-focus:bg-[#E1EF9A]  ${endpointIndex === 1 ? 'bg-[#E1EF9A] p-1' : ''}`}
              >
                <svg
                  width="33"
                  height="32"
                ...
                >
                  <path
                    className={`{${aboutStyles.custom_transition} fill-[#D9D9D9] group-hover:fill-[#ffffff] group-focus:fill-[#ffffff]  ${endpointIndex === 1 ? 'fill-[#ffffff]' : ''}`}
              ...
              <span
                className={`${aboutStyles.buttonText} ${aboutStyles.custom_transition} group-hover:text-[#1F1F1F] group-focus:text-[#1F1F1F]  ${endpointIndex === 1 ? 'text-[#1F1F1F]' : ''}`}
              >
                People
              </span>
            </div>
            <div
              className={`group ${aboutStyles.button} ${aboutStyles.custom_transition} hover:bg-white focus:bg-white ${endpointIndex === 2 ? 'bg-white' : ''}`}
              onClick={() => { setEndpointIndex(2) }}
            >
              <div
                className={`${aboutStyles.buttonIcons} ${aboutStyles.custom_transition} group-hover:bg-[#E1EF9A] group-hover:p-1 group-focus:bg-[#E1EF9A] ${endpointIndex === 2 ? 'bg-[#E1EF9A] p-1' : ''}`}
              >
                <svg
                  width="33"
                  height="33"
                ...
                >
                  <path
                    className={`{${aboutStyles.custom_transition} stroke-[#D9D9D9] group-hover:stroke-[#ffffff] group-focus:stroke-[#ffffff] ${endpointIndex === 2 ? 'fill-[#E1EF9A] stroke-[#ffffff]' : ''}`}
              ...
              <span
                className={`${aboutStyles.buttonText} ${aboutStyles.custom_transition} group-hover:text-[#1F1F1F] group-focus:text-[#1F1F1F] ${endpointIndex === 2 ? 'text-[#1F1F1F]' : ''}`}
              >
                <span>Colle</span>
            ...
            <div
              className={`group ${aboutStyles.button} ${aboutStyles.custom_transition} hover:bg-white focus:bg-white ${endpointIndex === 3 ? 'bg-white' : ''}`}
              onClick={() => { setEndpointIndex(3) }}
            >
              <div
                className={`${aboutStyles.buttonIcons} ${aboutStyles.custom_transition} group-hover:bg-[#E1EF9A] group-hover:p-1 group-focus:bg-[#E1EF9A] ${endpointIndex === 3 ? 'bg-[#E1EF9A] p-1' : ''}`}
              >
                <svg
                  width="33"
                  height="33"
                ...
                >
                  <path
                    className={`{${aboutStyles.custom_transition} stroke-[#D9D9D9] group-hover:stroke-[#ffffff] group-focus:stroke-[#ffffff] ${endpointIndex === 3 ? 'fill-[#E1EF9A] stroke-[#ffffff]' : ''}`}
                    d="M11.1666 9.66671C11.1666 11.0812 11.7285 12.4378 12.7287 13.4379C13.7289 14.4381 15.0855 15 16.5 15C17.9145 15 19.271 14.4381 20.2712 13.4379C21.2714 12.4378 21.8333 11.0812 21.8333 9.66671C21.8333 8.25222 21.2714 6.89567 20.2712 5.89547C19.271 4.89528 17.9145 4.33337 16.5 4.33337C15.0855 4.33337 13.7289 4.89528 12.7287 5.89547C11.7285 6.89567 11.1666 8.25222 11.1666 9.66671ZM3.83331 23C3.83331 24.4145 4.39522 25.7711 5.39541 26.7713C6.3956 27.7715 7.75216 28.3334 9.16665 28.3334C10.5811 28.3334 11.9377 27.7715 12.9379 26.7713C13.9381 25.7711 14.5 24.4145 14.5 23C14.5 21.5856 13.9381 20.229 12.9379 19.2288C11.9377 18.2286 10.5811 17.6667 9.16665 17.6667C7.75216 17.6667 6.3956 18.2286 5.39541 19.2288C4.39522 20.229 3.83331 21.5856 3.83331 23ZM18.5 23C18.5 24.4145 19.0619 25.7711 20.0621 26.7713C21.0623 27.7715 22.4188 28.3334 23.8333 28.3334C25.2478 28.3334 26.6044 27.7715 27.6045 26.7713C28.6047 25.7711 29.1666 24.4145 29.1666 23C29.1666 21.5856 28.6047 20.229 27.6045 19.2288C26.6044 18.2286 25.2478 17.6667 23.8333 17.6667C22.4188 17.6667 21.0623 18.2286 20.0621 19.2288C19.0619 20.229 18.5 21.5856 18.5 23Z"
                    strokeWidth="2.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <span
                className={`${aboutStyles.buttonText} ${aboutStyles.custom_transition} group-hover:text-[#1F1F1F] group-focus:text-[#1F1F1F] ${endpointIndex === 3 ? 'text-[#1F1F1F]' : ''}`}
              >
                APIs
              </span>
            </div>
            <div
              className={`group ${aboutStyles.button} ${aboutStyles.custom_transition} hover:bg-white focus:bg-white ${endpointIndex === 4 ? 'bg-white' : ''}`}
              onClick={() => { setEndpointIndex(4) }}
            >
              <div
                className={`${aboutStyles.buttonIcons} ${aboutStyles.custom_transition} group-hover:bg-[#E1EF9A] group-hover:p-1 group-focus:bg-[#E1EF9A] ${endpointIndex === 4 ? 'bg-[#E1EF9A] p-1' : ''}`}
              >
                <svg
                  className={`{${aboutStyles.custom_transition} fill-[#D9D9D9] group-hover:fill-[#ffffff] group-focus:fill-[#ffffff] ${endpointIndex === 4 ? 'fill-[#ffffff]' : ''}`}
                  width="33"
                  height="32"
                  viewBox="0 0 33 32"
                  fill="none"
              ...
              <span
                className={`${aboutStyles.buttonText} ${aboutStyles.custom_transition} group-hover:text-[#1F1F1F] group-focus:text-[#1F1F1F] ${endpointIndex === 4 ? 'text-[#1F1F1F]' : ''}`}
              >
                History
              </span>
            </div>
          ...
          <div className={aboutStyles.api_calls}>
            <div className='cursor-pointer' onClick={() => setEndpointIndex(1)}>
              <motion.div initial={{ width: endpointIndex === 1 ? '72px' : '62px' }} animate={{ width: endpointIndex === 1 ? '62px' : '72px' }} transition={{ delay: 0, duration: 0.3, type: "just" }} className='relative flex justify-start items-center'>
                <span className={`rounded-[32px] h-[30px] px-4 py-1.5 transition-all duration-500 flex items-center justify-center  ${endpointIndex === 1 ? 'bg-[#E1EF9A] text-[#2F20BF] w-[62px]' : 'bg-[#ECC89D] text-[#ffffff] w-[72px]'} `}>
            ...
            <div className='cursor-pointer' onClick={() => setEndpointIndex(2)}>
              <motion.div className='relative flex justify-start items-center'>
                <span className={`rounded-[32px] h-[30px] px-4 py-1.5 transition-all duration-500 flex items-center justify-center  ${endpointIndex === 2 ? 'bg-[#E1EF9A] text-[#2F20BF] w-[62px]' : 'bg-[#ECC89D] text-[#ffffff] w-[72px]'} `}>
            ...
            <div className='cursor-pointer' onClick={() => setEndpointIndex(3)}>
              <motion.div className='relative flex justify-start items-center'>
                <span className={`rounded-[32px] h-[30px] px-4 py-1.5 transition-all duration-500 flex items-center justify-center  ${endpointIndex === 3 ? 'bg-[#E1EF9A] text-[#2F20BF] w-[62px]' : 'bg-[#ECC89D] text-[#ffffff] w-[72px]'} `}>
            ...
            <div className='cursor-pointer' onClick={() => setEndpointIndex(4)}>
              <motion.div className='relative flex justify-start items-center'>
                <span className={`rounded-[32px] h-[30px] px-4 py-1.5 transition-all duration-500 flex items-center justify-center  ${endpointIndex === 4 ? 'bg-[#E1EF9A] text-[#2F20BF] w-[62px]' : 'bg-[#ECC89D] text-[#ffffff] w-[72px]'} `}>
