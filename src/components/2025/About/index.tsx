...
const About = () => {
  ...
  const [subsectionIndex] = useState(1);
    ...
    <section id="about" className={aboutStyles.aboutCont}>
      <div className={`${aboutStyles.row_one} flex items-center`}>
        <div className={aboutStyles.headerCont}>
          ...
          >
            At API Conf 2024, we're creating a melting pot of diverse ideas, backgrounds, and
            aspirations.
          </motion.h2>
        </div>
        <div className={aboutStyles.headerCont}>
          ...
          >
            Join us at API Conf Lagos 2024 to network with industry leaders, engage in hands-on
            learning through workshops and live demos, and explore innovative solutions driven by
            APIs across various sectors, including fintech and health tech. This event is an
            excellent opportunity for tech professionals to connect with top minds, gain practical
            skills and discover the latest advancements in API technology - all in one dynamic
            setting.
          </motion.p>
        </div>
      </div>
      ...
      >
        <div className={`${aboutStyles.row_two_col} ${aboutStyles.row_two_col_one}`}>
          ...
          <div className={aboutStyles.api_calls}>
            <div className="cursor-pointer" onClick={() => setEndpointIndex(1)}>
              <motion.div className="relative flex items-center justify-start">
                <span
                  className={`flex h-[30px] items-center justify-center rounded-[32px] px-4 py-1.5 font-bold transition-all duration-500 ${endpointIndex === 1 ? 'w-[62px] bg-[#E1EF9A] text-[#1F1F1F]' : 'w-[72px] bg-[#ECC89D] text-[#ffffff]'} `}
                >
              ...
              <div className={aboutStyles.api_url}>
                <p
                  className={`${endpointIndex === 1 ? 'text-[#1F1F1F]' : 'text-[#D9D9D9]'} transition-all duration-500`}
                >
            ...
            <div className="cursor-pointer" onClick={() => setEndpointIndex(2)}>
              <motion.div className="relative flex items-center justify-start">
                <span
                  className={`flex h-[30px] items-center justify-center rounded-[32px] px-4 py-1.5 font-bold transition-all duration-500 ${endpointIndex === 2 ? 'w-[62px] bg-[#E1EF9A] text-[#1F1F1F]' : 'w-[72px] bg-[#ECC89D] text-[#ffffff]'} `}
                >
              ...
              <div className={aboutStyles.api_url}>
                <p
                  className={`${endpointIndex === 2 ? 'text-[#1F1F1F]' : 'text-[#D9D9D9]'} transition-all duration-500`}
                >
                  <span>apiconf.net/api/</span>
                  <span>...</span>
                </p>
            ...
            <div className="cursor-pointer" onClick={() => setEndpointIndex(3)}>
              <motion.div
                initial={{ width: endpointIndex === 1 ? '72px' : '62px' }}
                animate={{ width: endpointIndex === 1 ? '62px' : '72px' }}
                transition={{ delay: 0, duration: 0.3, type: 'just' }}
                className="relative flex items-center justify-start"
              >
                <span
                  className={`flex h-[30px] items-center justify-center rounded-[32px] px-4 py-1.5 font-bold transition-all duration-500 ${endpointIndex === 3 ? 'w-[62px] bg-[#E1EF9A] text-[#1F1F1F]' : 'w-[72px] bg-[#ECC89D] text-[#ffffff]'} `}
                >
              ...
              <div className={aboutStyles.api_url}>
                <p
                  className={`${endpointIndex === 3 ? 'text-[#1F1F1F]' : 'text-[#D9D9D9]'} transition-all duration-500`}
                >
                  <span>apiconf.net/api/</span>
                  <span>...</span>
                </p>
            ...
            <div className="cursor-pointer" onClick={() => setEndpointIndex(4)}>
              <motion.div className="relative flex items-center justify-start">
                <span
                  className={`flex h-[30px] items-center justify-center rounded-[32px] px-4 py-1.5 font-bold transition-all duration-500 ${endpointIndex === 4 ? 'w-[62px] bg-[#E1EF9A] text-[#1F1F1F]' : 'w-[72px] bg-[#ECC89D] text-[#ffffff]'} `}
                >
              ...
              <div className={aboutStyles.api_url}>
                <p
                  className={`${endpointIndex === 4 ? 'text-[#1F1F1F]' : 'text-[#D9D9D9]'} transition-all duration-500`}
                >
                  <span>apiconf.net/api/</span>
                  <span>...</span>
                </p>
        ...
        <motion.div
          initial={{ height: '470px' }}
          animate={{
            height:
              endpointIndex === 4 || endpointIndex === 2
                ? '520px'
                : endpointIndex === 1
                  ? '500px'
                  : '470px',
          }}
          className={`${aboutStyles.row_two_col} ${aboutStyles.row_two_col_two} relative h-auto`}
        >
          <div className="relative flex h-auto w-full flex-col items-start justify-start">
            <div
              className={`absolute left-0 top-0 flex h-full w-full flex-col justify-between gap-6 transition-opacity duration-300 ${endpointIndex === 1 ? 'opacity-100' : 'opacity-0'}`}
            >
              <div>
              ...
              <div>
                ...
                <p className={aboutStyles.para_dark}>
                  They don't just observe the trends; they set them. With vast followers, these
                  individuals have the power to amplify messages and shape opinions.
                </p>
              </div>
              <div>
                <h3 className={aboutStyles.head3}>API Vendors and Solution Providers</h3>
                <p className={aboutStyles.para_dark}>
                  The entities that provide the tools, platforms, and solutions which developers and
                  companies rely upon. They're always on the prowl for new partnerships,
                  collaborations, and opportunities.
                </p>
              </div>
            </div>
            <div
              className={`absolute left-0 top-0 flex h-full w-full flex-col justify-between gap-6 transition-opacity duration-300 ${endpointIndex === 2 ? 'opacity-100' : 'opacity-0'}`}
            >
              <div>
              ...
              <div>
                ...
                <p className={aboutStyles.para_dark}>
                  Senior management and executives who see the larger picture. They gauge market
                  trends, forecast future trajectories, and make pivotal decisions that shape the
                  tech landscape.
                </p>
              </div>
              <div>
                ...
                <p className={aboutStyles.para_dark}>
                  The problem solvers who embark on the challenging journey of turning visions into
                  reality. They're always on the lookout for leveraging APIs to offer innovative
                  solutions to everyday problems.
                </p>
              </div>
            </div>
            <div
              className={`absolute left-0 top-0 flex h-full w-full flex-col justify-between gap-6 transition-opacity duration-300 ${endpointIndex === 3 ? 'opacity-100' : 'opacity-0'}`}
            >
              <div>
              ...
              <div>
                ...
                <p className={aboutStyles.para_dark}>
                  Expertise in software development and experience in harnessing the power of APIs
                  for intricate integrations and solutions.
                </p>
              </div>
              <div>
                <h3 className={aboutStyles.head3}>Emerging Tech Talents</h3>
                <p className={aboutStyles.para_dark}>
                  Young and enthusiastic coders eager to explore the vast world of APIs, bringing
                  fresh perspectives and innovative approaches.
                </p>
              </div>
            </div>
            <div
              className={`absolute left-0 top-0 flex h-full w-full flex-col justify-between gap-6 transition-opacity duration-300 ${endpointIndex === 4 ? 'opacity-100' : 'opacity-0'}`}
            >
              <div>
              ...
              <div>
                ...
                <p className={aboutStyles.para_dark}>
                  Individuals who, while not directly involved in hands-on development, are
                  intrigued by the potential and prospects of APIs, They could be from adjacent
                  sectors like marketing, finance, or design, keen to understand how APIs influence
                  their domains.
                </p>
              </div>
              <div>
                ...
                <p className={aboutStyles.para_dark}>
                  They bring a blend of curiousity and ambition, while their journey in the tech
                  world has just begun, their aspirations are sky-high. They're here to learn,
