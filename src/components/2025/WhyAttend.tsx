  ...
  return (
    ...
    >
      <div className="flex-1 space-y-8">
        ...
        >
          API Conf Lagos 2025 is Africa’s premier API literacy and innovation conference, uniting
          experts and industry leaders to drive digital transformation. This is an opportunity to
          explore real-world use cases, engage with leaders and disruptors in the ecosystem, and
