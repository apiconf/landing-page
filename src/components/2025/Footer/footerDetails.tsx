      ...
      <div className={footerDetailStyle.content}>
        ...
        >
          <li className={footerDetailStyle.link}>
            <Link to="/2025/code-of-conduct" className={footerDetailStyle.linkText}>
              Code of Conduct
            </Link>
            <img className={footerDetailStyle.linkIcon} src={arrow} alt="arrow-icon" />
          </li>
          <li className={footerDetailStyle.link}>
            <Link to="/2025/sponsors" className={footerDetailStyle.linkText}>
              Work With Us
            </Link>
            <img className={footerDetailStyle.linkIcon} src={arrow} alt="arrow-icon" />
          </li>
          <li className={footerDetailStyle.link}>
            <Link to="/2025/schedule" className={footerDetailStyle.linkText}>
              Event Schedule
            </Link>
            <img className={footerDetailStyle.linkIcon} src={arrow} alt="arrow-icon" />
          </li>
          <li className={footerDetailStyle.link}>
            <a href="/2025/speakers" className={footerDetailStyle.linkText}>
              speakers
            </a>
            <img className={footerDetailStyle.linkIcon} src={arrow} alt="arrow-icon" />
          </li>
