...
const FaqItem = ({
  ...
  return (
    <motion.div
      layout
      className="cursor-pointer select-none rounded-2xl bg-white p-[8.054%] sm:p-6"
      onClick={() => {
        if (itemOpen) {
          setActiveQues(-1);
          return;
    ...
    >
      <div className="flex items-center justify-between gap-4">
        <p className="text-lg font-bold leading-none md:text-xl lg:text-2xl">{faqQuestion}</p>
        <motion.img
      ...
      <motion.p
        ...
        className="overflow-hidden text-lg leading-[22.32px] md:text-xl md:leading-[24.8px] lg:text-2xl lg:leading-[29.76px]"
      >
        {faqResponse}
      </motion.p>
    </motion.div>
