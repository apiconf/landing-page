    ...
    <div ref={headerRef}>
      ...
      >
        <Link to="/2025" rel="noopener noreferrer">
          <img className="h-auto w-full max-w-[155.36px]" src="/logo2025.svg" alt="apiconf logo" />
        </Link>

        <ul className="flex items-center gap-x-4 text-lg font-bold leading-none text-white sm:gap-x-8 lg:text-2xl">
          <li>
            {' '}
            <a href="/2025/#spaces" rel="noopener noreferrer" className="">
              Spaces
            </a>
          </li>
          <li>
            {' '}
            <a href="/2025/#faqs" rel="noopener noreferrer" className="">
              FAQs
            </a>
          </li>
          <li className="hidden sm:block">
            {' '}
            <a href="/2025/teams" rel="noopener noreferrer" className="whitespace-nowrap">
              Meet the team
            </a>
          </li>
        </ul>
