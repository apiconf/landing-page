    ...
    <div className='w-full h-max mb-5 bg-[#4121CF] lg:p-12 p-8 flex flex-col items-start gap-5 '>
      ...
      <div className='grid lg:grid-cols-3 gap-4 w-full'>
        <div className='items-center text-center flex justify-center flex-col rounded-3xl bg-white h-[120px] p-8'>
          <h1 className='text-2xl font-bold text-[#4121CF]'>For More Inquiries on Sponsorship</h1>
        </div>
        <div className='items-center text-center flex justify-center flex-col gap-2 rounded-3xl bg-gradient-to-r from-[#ECC89D] to-[#E2EF9C] h-[120px]'>
          <div className={`w-[200px]  rounded-full text-xl p-2 text-[#4121CF] font-bold name-bg`}>
            SODIQ AKINJOBI
          </div>
