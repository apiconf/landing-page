...
export default function SponsorSection() {
  ...
  return (
    <>
      ...
      <div className="bg-[#90EAF2] px-6 pb-24 pt-16 text-[#1F1F1F] md:p-32">
        <h3 className="text-4xl font-bold md:text-5xl">Sponsor APIConf Lagos 2025</h3>
        ...
        <a
          ...
          target="_blank"
          className="flex w-full max-w-[330px] cursor-pointer items-center justify-center gap-2 rounded-[20rem] bg-[#2F20BF] p-6 sm:px-4 sm:py-8 md:px-16 lg:w-[70.01%] lg:max-w-[467px] lg:py-8"
        >
