...
export const speakers: person[] = [
  ...
  },
  {
    ...
    image: '/Taiwo-coker.jpg',
    sessionFormat: 'Panelist',
  },
  {
    index: 49,
    name: 'Awonuga Sherif',
    jobTitle: 'CTO Autocredit payment & Director Tech Talent Academy',
    employer: '',
    bio: "The Future of APIs in an AI-First World - Will LLMs change how we design, expose, and secure APIs?",
    image: '/Awonuga-sherif.jpg',
    sessionFormat: 'Panelist',
  },
  {
    index: 49,
    name: 'Robert (Thas) John',
    jobTitle: 'Data Scientist at Versus & Google Developer Expert',
    employer: '',
    bio: "The Future of APIs in an AI-First World - Will LLMs change how we design, expose, and secure APIs?",
    image: '/Robert-john.jpg',
    sessionFormat: 'Panelist',
  },
  {
    index: 49,
    name: 'Luc Okalobe',
    jobTitle: 'Founder & CEO Yamify',
    employer: '',
    bio: "The Future of APIs in an AI-First World - Will LLMs change how we design, expose, and secure APIs?",
